...
const handler = asyncError(async (req, res) => {
  ...
  if (!bookingId)
    return errorHandler(res, 400, "Booking ID is required");
  ...
  try {
    ...
    if (!booking)
      return errorHandler(res, 400, "Invalid booking ID");
     ...
     if (!packagePrice)
  return errorHandler(res, 400, "Booking does not contain package information");
    ...
    const options = {
      ...
      headers: {
        'x-api-key': '9d6faae816329d7ee295305768802829ee5e1a4f28fd41e5a3d7b885c6864f7105ee227b67eefca1c4c86c69834acbf567b2bc1cb3be52058b976c3cdbd30473',
      ...
      body: JSON.stringify({
        ...
        Do_UsrAuth: {
          UsrSessnUID: "73bd664a94324428da6bd9085bb6a5bc85d4a21f460a599d9de19edb18f71dce634220ed5ae4ca54d1f31812387492b32049b21e0642fea6653f6f4e919b3709",
          AuthTyp: "2",
        },
        DBRqst: "Save_N",
        Do_Dvcinfo: {
